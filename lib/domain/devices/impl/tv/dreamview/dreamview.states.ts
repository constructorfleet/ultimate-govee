...
export class MicModeState extends DeviceOpState<MicModeStateName, MicMode> {
  constructor(
    ...
    identifier: number[] = [0x05, DreamviewModes.MUSIC],
  ) {
...
export class SceneModeState extends LightEffectState {
  constructor(
    device: DeviceModel,
    opType: number = OpType.REPORT,
    identifier: number[] = [0x05, DreamviewModes.SCENE],
  ) {
...
export class DIYModeState extends DeviceOpState<DIYModeStateName, DIYModeData> {
  constructor(device: DeviceModel) {
    super(
      { opType: OpType.REPORT, identifier: [5, DreamviewModes.DIY] },
      device,
      DIYModeStateName,
      {},
    );

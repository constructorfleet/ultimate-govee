...
def test_decode_properties_maps_values():
    ...
    properties = {
        "tempc": {"decoder": ["value_from_hex_string", "manufacturerdata", 6, 6, False, False], "post_proc": ["/", 1000, ">", 0, "/", 10]},
        "batt": {"decoder": ["value_from_hex_string", "manufacturerdata", 14, 2, False, False]},
    }
